...
const skillsData = {
    frontend: {
        ...
        skills: [
            ...
            { icon: 'fas fa-wind', label: 'Tailwind', delay: 2 as const },
    ...
    backend: {
        ...
        skills: [
            ...
            { icon: 'fas fa-server', label: 'Nginx', delay: 2 as const },
        ],
    },
    automation: {
        title: 'AUTOMATION',
        ...
        skills: [
            { icon: 'fas fa-cogs', label: 'n8n', delay: 2 as const },
            { icon: 'fab fa-microsoft', label: 'Power Automate', delay: 4 as const },
            { icon: 'fas fa-chart-bar', label: 'Power BI', delay: 1 as const },
            { icon: 'fab fa-microsoft', label: 'SPFx', delay: 3 as const },
            { icon: 'fas fa-share-alt', label: 'SharePoint', delay: 2 as const },
