...
const projectsData: Project[] = [
    // Website Projects
    {
        ...
        titleKey: 'p4-title',
        descKey: 'p4-desc',
        link: 'https://www.signpoint.my.id/',
    ...
    {
        images: ['/projects/digital-archive.png'],
        category: 'WEBSITE',
        categoryColor: 'cyan',
        titleKey: 'p13-title',
        descKey: 'p13-desc',
        techStack: ['Laravel', 'React', 'Tailwind', 'MySQL','TypeScript'],
        tab: 'website',
    },
    {
        images: ['/projects/alumni-tracer.png'],
        category: 'WEBSITE',
        categoryColor: 'purple',
        titleKey: 'p14-title',
        descKey: 'p14-desc',
